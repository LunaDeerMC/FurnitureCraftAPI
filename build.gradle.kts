...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name = project.name
                description = "Minecraft Bukkit Server FurnitureCraft Plugin API"
                url = "https://furniturecraft.lunadeer.cn/"
                licenses {
                    license {
                        name = "MIT"
                ...
                scm {
                    connection = "https://github.com/LunaDeerMC/FurnitureCraft.git"
                    developerConnection = "scm:git@github.com:LunaDeerMC/FurnitureCraft.git"
                    url = "https://github.com/LunaDeerMC/FurnitureCraft"
                }
                dependencies {
...
tasks.named("generatePomFileForMavenJavaPublication") {
    finalizedBy("removePomDependenciesWithGroupIdFurnitureCraftAPI")
}
// remove subproject dependencies from pom file
tasks.register("removePomDependenciesWithGroupIdFurnitureCraftAPI") {
    doLast {
        val pomFile =
        ...
        nodes.forEach { n ->
            ...
            if (name == "dependencies") {
                ...
                node.children().forEach {
                    ...
                    if (dependency.text().contains("FurnitureCraftAPI")) {
